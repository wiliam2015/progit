...
Converter.prototype.generateIndexPage = function () {
    ...
    var indexPagePath = getPath(this.destination, indexPageName);
    ...
    function generateChapter(chapterContent, index) {
        ...
        function getPageSidebar() {
            ...
            return '<li class="nav-header">' +
                   '<a href="#!/html/' + self.translation + '/ch' + index + '_0.html">' +
        ...
        function imageReplace(text) {
            return text.replace(/Insert ([^\.]+).png/g, function (all, figure) {
                return '<img class="img-responsive center-block" src="../../book/figures/' + figure + '-tn.png"></br>';
            });
        }
    }
};
...
Converter.prototype.getRender = function () {
    ...
    var indexCompiler = getCompiler(tplIndex, tplLayout);
    var pageCompiler = getCompiler(tplPage, tplLayout);
    ...
    function getCompiler(tpl, relativeTemplateName) {
        ...
        var compiler = jade.compile(templateString, {});
